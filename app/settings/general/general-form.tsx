  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
        <ProfilePicture />
        <div className='flex flex-row gap-5' style={{ marginTop: 0 }}>
        ...
        {/* Online Presense */}
        <h2 className='text-black font-bold text-2xl '>Online presense</h2>
        <OnlinePresenceModal />
          ...
          return (
            <div key={`link-${index}`} className='relative w-full h-[74px]  '>
              ...
              <Trash2
                ...
                size={18}
                type='button'
                onClick={() => removeLink(link.platform, link.url)}
              />
            </div>
          );
        })}
