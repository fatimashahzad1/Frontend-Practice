...
const AccountTypeCard = () => {
  ...
  return (
    <div
      className="max-w-[426px] h-[108px] m-7 bg-white shadow-custom rounded-md bg-primaryBlue hover:bg-hoverBlue p-7 hover:border-primaryBlue hover:border-[1px] flex flex-row justify-between items-center"
      onMouseEnter={() => {
        setHovered(true);
      }}
      onMouseLeave={() => {
