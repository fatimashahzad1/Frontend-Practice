...
const AccountTypeCard = () => {
  ...
  return (
    <Link
      href="/account"
      className="max-w-[426px] h-[108px] bg-white shadow-custom rounded-md bg-primaryBlue hover:bg-hoverBlue p-7 hover:border-primaryBlue hover:border-[1px] flex flex-row justify-center items-center"
      onMouseEnter={() => {
        setHovered(true);
      }}
      onMouseLeave={() => {
